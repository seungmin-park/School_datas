...
func (s student) study() {
	fmt.Printf("%s은 %s과목을 공부합니다", s.name, s.subject)
}
...
func funcStudy(fs student) {
	fmt.Printf("%s은 %s과목을 공부합니다", fs.name, fs.subject)
}
func main() {
...
// 	carFuel = carFuel + GallonsToLiters(10.0)
// 	busFuel = busFuel + LitersToGallons(10.0)
